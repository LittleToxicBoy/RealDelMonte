<div>
    @if ($accion == 'agregar')
        <form wire:submit.prevent="agregarRecorrido">
            ...
            <div class="input-group mb-3">
                <input type="number" wire:model="costo" class="form-control" placeholder="Casa abandonada">
            </div>
            @error('precio')
                <div class="alert alert-danger" role="alert">
                    <strong>{{ $message }}</strong>
            ...
            <label style="color: black !important;">
                <p class="m-0">Duracion</p>
            </label>
            <div class="input-group mb-3">
                <input type="text" wire:model="duracion" class="form-control" placeholder="Casa abandonada">
            </div>
            @error('descripcion')
                <div class="alert alert-danger" role="alert">
                    <strong>{{ $message }}</strong>
    ...
    @endif
    @if ($accion == 'editar')
        <form wire:submit.prevent="editarRecorrido">
            <label style="color: black !important;">
            <p class="m-0">Nombre</p>
            </label>
            <div class="input-group mb-3">
