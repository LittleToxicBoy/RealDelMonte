<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 ps" id="sidenav-main">
    ...
    <div class="sidenav-footer mx-3">
        ...
        <a class="btn btn-primary btn-sm mb-0 w-100" style="margin-top: 80%;" href="https://www.creative-tim.com/product/argon-dashboard-pro?ref=sidebarfree" type="button">Cerrar sesion</a>
    </div>
</aside>